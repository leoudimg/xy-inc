	...
	<div class="row-fluid">
		...
		<div class="block">
			...
			<form class="form-horizontal"
				action="<c:url value="/atributo/inserir"/>" method="POST">
				<fieldset>
					<div class="block-content collapse in">
						<div class="span12">
							...
							<div class="control-group">
								<label class="control-label" for="focusedInput">Modelos
									Disponíveis:</label>
								<div class="controls">
							...
							<div class="control-group">
								<label class="control-label" for="focusedInput">Tipo do Atributo:</label>
								<div class="controls">
									<select class="form-control" name="atributo.indicadorTipoAtributo">
